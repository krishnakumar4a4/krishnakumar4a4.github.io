...
title = "DIY: In meeting indicator - WFH Utility"
description = "DIY: In meeting indicator - WFH Utility"
date = 2021-04-04T00:00:00+05:30
tags = [
    "meeting",
    "DIY",
    "WFH",
...
aliases = ["utilities"]
images = [
  "/images/in-meeting-indicator-overview.png",
]
+++

# DIY: In meeting indicator - WFH Utility

{{< figure src="/images/in-meeting-indicator-meme1.png" title="The need for in meeting indicator at home" >}}
...
{{< figure src="/images/in-meeting-indicator-visual-output.png" title="Goal of in meeting indicator" >}}
...
{{< figure src="/images/in-meeting-indicator-overview.png" title="Interaction diagram of nodeMCU, Raspberry Pi4 and Mac Laptop" >}}

**Here is a short demo video**
{{< youtube id="7trE5USEL08" autoplay="true" title="In Meeting Indicator Demo" >}}
...
{{< figure src="/images/create-new-atomator-app.png" title="Create a new automator application" >}}

{{< figure src="/images/run-shell-script-in-automator-app.png" title="Run shell script from automator" >}}
...
{{< figure src="/images/nse-970011749336351535-1585045123.jpg" title="Early Version: In Meeting indicator LEDs taped to the back of my external monitor" >}}
